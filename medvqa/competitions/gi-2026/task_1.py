...
parser = argparse.ArgumentParser(description='Run MEDVQA-GI 2026 Task 1 (Clinically Relevant Visual Question Answering)')
...
print("🌟 ImageCLEFmed-MEDVQA-GI-2026 🌟",
      "https://github.com/simula/ImageCLEFmed-MEDVQA-GI-2026")
print("🔍 Subtask 1: Clinically Relevant Visual Question Answering")
...
client = Client("SimulaMet/MedVQA-GI-2026")
...
if not MEDVQA_SUBMIT:
    ...
    Client("SimulaMet/MedVQA-GI-2026")
