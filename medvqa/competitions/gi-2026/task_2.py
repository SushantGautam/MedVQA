...
parser = argparse.ArgumentParser(
    description='Run MEDVQA-GI 2026 Task 2 (Multimodal Explainability and Safety-Aware Reasoning)')
...
print("💬 Subtask 2: Multimodal Explainability and Safety-Aware Reasoning")
